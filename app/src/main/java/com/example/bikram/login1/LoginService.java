...
/**
 * Created by bikram on 2/13/2017.
 */
...
public class LoginService extends IntentService {
    ...
    Profile init(SocialMediaProvider provider) throws AuthenticationException {
        Log.d("tag","login serv");
        Profile profile = null;   // polymorphism
        switch (provider) {
            case FACEBOOK:
                profile = new Facebook(this, "1717600921864358", "dc91637edb086b2b105b19b33cf4b876");
                break;
            case TWITTER:
                profile = new Twitter(this, "pDois0EU9tEkQEZfMtfuFv8pX", "Bpfj9c0xmWQLwyaLB1o95cblRmkfsdH8ATMSJXjLRzYyMpTRFN");
                break;
            case GOOGLE_PLUS:
                profile = new GooglePlus(this, getString(R.string.google_plus_app_key), getString(R.string.google_plus_app_secret));
                break;
            case INSTAGRAM:
                profile = new Instagram(this, "74193b63742247f1b506f079078b9259", " 537dd7b0b165449197d1e7a64413593a ");
                break;
            case LINKED_IN:
